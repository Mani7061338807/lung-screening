  ...
  return (
    <Screen>
      <div className="text-[#043a66] text-left text-sm font-medium">
        ...
        <p className="mb-4">
          This Terms of Agreement is a binding legal contract between you and
          the Lung Cancer Screening app. By downloading, accessing or using any
          part of this app, you are bound by the terms of this agreement.
        </p>
        ...
        <ol className="list-decimal pl-4 space-y-3 text-[13px]">
          <li>
            ...
            information, which is governed by our privacy policy and consent
            form. You agree not to access or use the app in an unlawful way, for
            any unlawful purpose, or for any purposes other than its intended
            purposes.
          </li>
          <li>
            <strong>Disclaimer:</strong> This app is intended to be used for
            general educational and informational purposes only. It should not
            be relied upon as a substitute for a doctor’s professional medical
            judgment or medical advice. Use of this app is at your sole risk.
            You assume full responsibility for all risk associated with this
            app, without any warranties and conditions.
          </li>
          <li>
          ...
          <li>
            ...
            property of Lung Cancer Screening app, and are protected by the
        ...
        <p className="mt-4 text-[13px]">
          The app is operated by Montefiore Health System, Inc. Please direct
          all feedback, comments, requests for technical support, etc to{" "}
